...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <div class="row bg-white m-md-4 p-md-3 pt-3">
        <div class="col-md-9">
          <h1 class="h3 mb-0 text-gray-800"><a href="{{url('/')}}">Principal</a> / Asignaturas
            <i class="fas fa-swatchbook prefix"></i></h1>
        </div>

        <div class="col-md-3">
          <div class="md-form p-0 m-0">
           <i class="fas fa-swatchbook prefix"></i>
            <input id="SearchBook" type="text" id="materialFormCardNameEx" class="form-control" placeholder="Buscar asignatura">
          </div>
        </div>
    </div>
    ...
    <div class="row bg-white m-md-4 px-2 px-md-5 pt-4">
      <div class="col-md-12 col-xs-12">
				<a class="btn bg-primary text-white float-right btn-sm" href="{{url('catalogos/asignaturas/create')}}">Registrar asignatura</a>
      </div>
