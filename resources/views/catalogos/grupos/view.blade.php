...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <div class="row bg-white m-md-4 p-md-3 pt-3">
        <div class="col-md-9">
          <h1 class="h3 mb-0 text-gray-800"><a href="{{url('/')}}">Principal</a> /  Grupos
        ...
        <div class="col-md-3">
          <div class="md-form p-0 m-0">
           <i class="fas fa-users prefix"></i>
            <input id="SearchBook" type="text" id="materialFormCardNameEx" class="form-control" placeholder="Buscar grupo">
          </div>
        </div>
    </div>
  @if(session()->has('delete'))
    ...
    <div class="row bg-white m-md-4 px-2 px-md-5 pt-4">
      <div class="col-md-12 col-xs-12">
				<a class="btn bg-primary text-white float-right btn-sm" href="{{url('catalogos/grupos/create')}}">Registrar grupo</a>
      </div>
...
<script type="text/javascript" src="{{url('public')}}/js/addons/datatables-es.js"></script>
 <script type="text/javascript">
    ...
    var table = $('#TablaAlumnos').DataTable(
        ...
        processing: true,
        ordering: true,
        ajax: '{!! url("grupos-data") !!}',
        columns: [
            { data: 'id', name: 'id',class: "id-number"},
            { data: 'semestre', name: 'semestre'},
            { data: 'grupo', name: 'grupo', class : "text-capitalize"},
