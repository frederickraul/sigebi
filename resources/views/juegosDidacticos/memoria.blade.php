...
<!-- Begin Page Content -->
  ...
  <div class="back p-5 bg-info text-white">
    ...
    <input class="btn btn-info" type="button" value="Reset" onclick="resetearJuego()" /> 
          ...
          <table>
        <tr>
          <td id="0" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="1" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="2" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="3" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
        ...
        <tr>
          <td id="4" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="5" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="6" class="letra memory-card" onclick="girarCarta()" data-valor="valor"><div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
              Back content
            </div></td>
          <td id="7" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
        ...
        <tr>
          <td id="8" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="9" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="10" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="11" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
        ...
        <tr>
          <td id="12" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="13" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="14" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
          ...
          <td id="15" class="letra memory-card" onclick="girarCarta()" data-valor="valor">
            <div class="front p-5 bg-danger text-white"> 
              ?
            </div> 
            <div class="back p-5 bg-info text-white">
