...
<style type="text/css">
    .bg-login-image{
    background-image: url('{{url('resources/')}}/img/undraw/undraw_book_lover_mkck.svg') !important;
  ...
  <div class="container-fluid">
    ...
    <div class="row bg-white m-md-4 p-md-3 pt-3">
        <div class="col-md-6">
          ...
          <a href="{{url('/libros')}}"> / Libros </a> / Detalles
           <i class="fas fa-book"></i><sup><i class="fas fa-info-circle"></i></sup></h1>
        </div>
    </div>
                ...
                <div class="form-group">
                  <div class="row m-0 p-0">
                    <div class="col-md-9 col-xs-9">
                      <div class="md-form">
                      <input type="text" class="text-uppercase form-control{{ $errors->has('clasificacion') ? ' is-invalid' : '' }}" value="{{ old('clasificacion', $libro->clasificacion) }}" id="clasificacion" name="clasificacion" readonly="true"> 
...
<!-- Titulo -->
                <div class="form-group">
                  <div class="row m-0 p-0">
                    <div class="col-md-9 col-xs-9">
                      <div class="md-form">
                      <input type="text" class="text-capitalize form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" value="{{ old('titulo', $libro->titulo) }}" id="titulo" name="titulo"> 
                      <label for="titulo" class="text-bolder active"><i class="text-danger"> * </i>Título</label>
                    </div>
...
<!-- Titulo -->
                <div class="form-group">
                  <div class="row m-0 p-0">
                    <div class="col-md-9 col-xs-9">
                      <div class="md-form">
                      <input type="text" class="text-capitalize form-control" value="{{ old('subtitulo', $libro->subtitulo) }}" id="subtitulo" name="subtitulo"> 
                      <label for="subtitulo" class="pl-2 text-bolder active">Subtítulo</label>
                    </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row m-0 p-0">
                    <div class="col-md-8 col-xs-8 p-0"> 
                      <div class="md-form">
                          ...
                          <select class="text-capitalize text-bolder ml-2 form-control{{ $errors->has('autor') ? ' is-invalid' : '' }}" name="autor" id="autor">
                          ...
                          {{ (old('nivel_1') == '') ? ' empty' : '' }}" name="nivel_1" id="nivel_1">
                            ...
                            @foreach($categorias as $categoria)
                              <option value="{{$categoria->id}}" 
                                {{ ($libro->Categoria['first_category_id'] == $categoria->id) ? 'selected' : '' }}> {{$categoria->concepto}}</option>
                            @endforeach
                          </select>
                ...
                <div class="form-group m-0 p-0">
                  <div class="row m-0 p-0">
                    <div class="col-md-11 col-xs-11 p-0"> 
                      <div class="md-form">
                          <label class="text-danger"> * </label>
                          <select class="ml-2 form-control{{ $errors->has('nivel_2') ? ' is-invalid' : '' }}
                          {{ (old('nivel_2') == '') ? ' empty' : '' }}" name="nivel_2" id="nivel_2">
                ...
                <div class="form-group m-0 p-0">
                  <div class="row m-0 p-0">
                    <div class="col-md-11 col-xs-11 p-0"> 
                      <div class="md-form">
                          <label class="text-danger"> * </label>
                          <select class="ml-2 form-control{{ $errors->has('nivel_3') ? ' is-invalid' : '' }}
                          {{ (old('nivel_3') == '') ? ' empty' : '' }}" name="nivel_3" id="nivel_3">
...
<!-- Titulo -->
                ...
                <input id="iniciales" type="hidden" name="iniciales" value="{{$libro->iniciales}}">
...
<script type="text/javascript">
  var nivel_1;
  var nivel_2       = '{!! old('nivel_2',$libro->categoria) !!}';
  var nivel_3       = '{!! old('nivel_3',$libro->subcategoria) !!}';
  var autor         ='{!! old('autor') !!}';
  var clasificacion;
  var categoria;
