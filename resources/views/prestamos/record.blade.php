...
<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <div class="row bg-white m-md-4 p-md-3 pt-3">
        <div class="col-md-9">
          <h1 class="h3 mb-0 text-gray-800"><a href="{{url('/')}}">Principal</a> / <a href="{{url('/prestamos')}}">Prestamos</a> / Historial
           <i class="fas fa-book-reader"></i><sup><i class="fas fa-clock"></i></sup></h1>
        </div>
